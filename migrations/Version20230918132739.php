 ...
 */
final class Version20230918132739 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media ADD CONSTRAINT FK_6A2CA10C6D69186E FOREIGN KEY (figure_id_id) REFERENCES figure (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
